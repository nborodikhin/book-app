...
Defines the behavior of the Bookmarks tab, including offline display of saved books, list item presentation, data fetch/storage on first bookmark, data retention policy, state persistence, and navigation to book detail.
