# android-lint-config Specification

## Purpose

Defines requirements for Android lint configuration, including baseline-based suppression of pre-existing issues, enforcement via `abortOnError`, and documentation of lint as a required pre-merge step.
