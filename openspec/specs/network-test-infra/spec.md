# network-test-infra Specification

## Purpose

Defines requirements for the test infrastructure modules that replace production Hilt bindings during instrumentation tests, including `FakeNetworkModule`, `FakeDataStoreModule`, and `MockWebServerRule`.
